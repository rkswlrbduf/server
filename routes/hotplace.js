...
var query = "SELECT S.STORE_ID, STORE_NM, STORE_B_LCN, STORE_TIME, STORE_CALL, STORE_CODE, STORE_DONG, STORE_DT, T.THEME_ID, T.THEME_NM, STORE_IMG FROM storeInform S INNER JOIN storeThemeInform ST ON S.STORE_ID = ST.STORE_ID INNER JOIN themeInform T ON ST.THEME_ID = T.THEME_ID ORDER BY S.STORE_ID DESC";
