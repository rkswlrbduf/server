...
var query = "SELECT " +
    "S.STORE_ID, STORE_NM, STORE_M_LCN, STORE_TYPE, STORE_CODE, STORE_DT, T.THEME_ID, T.THEME_NM, STORE_CALL, STORE_B_LCN, STORE_IMG " +
...
//var query = "T.THEME_ID, T.THEME_NM FROM storeInform S INNER JOIN storeThemeInform ST ON S.STORE_ID = ST.STORE_ID INNER JOIN themeInform T ON ST.THEME_ID = T.THEME_ID";
